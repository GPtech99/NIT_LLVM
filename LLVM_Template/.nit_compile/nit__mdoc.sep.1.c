...
/* method mdoc#MDoc#content= for (self: MDoc, Array[String]) */
void nit___nit__MDoc___content_61d(val* self, val* p0) {
self->attrs[COLOR_nit__mdoc__MDoc___content].val = p0; /* _content on <self:MDoc> */
RET_LABEL:;
}
/* method mdoc#MDoc#original_mentity for (self: MDoc): nullable MEntity */
val* nit___nit__MDoc___original_mentity(val* self) {
val* var /* : nullable MEntity */;
val* var1 /* : nullable MEntity */;
var1 = self->attrs[COLOR_nit__mdoc__MDoc___original_mentity].val; /* _original_mentity on <self:MDoc> */
var = var1;
RET_LABEL:;
return var;
}
...
val* nit___nit__MDoc___location(val* self) {
val* var /* : Location */;
val* var1 /* : Location */;
var1 = self->attrs[COLOR_nit__mdoc__MDoc___location].val; /* _location on <self:MDoc> */
if (unlikely(var1 == NULL)) {
...
/* method mdoc#MEntity#mdoc_or_fallback for (self: MEntity): nullable MDoc */
val* nit__mdoc___MEntity___mdoc_or_fallback(val* self) {
val* var /* : nullable MDoc */;
val* var1 /* : nullable MDoc */;
{
var1 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__mdoc__MEntity__mdoc]))(self); /* mdoc on <self:MEntity>*/
}
var = var1;
goto RET_LABEL;
RET_LABEL:;
