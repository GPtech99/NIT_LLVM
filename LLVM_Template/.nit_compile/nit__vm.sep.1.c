#include "nit__vm.sep.0.h"
/* method vm#ModelBuilder#run_virtual_machine for (self: ModelBuilder, MModule, Array[String]) */
void nit__vm___ModelBuilder___run_virtual_machine(val* self, val* p0, val* p1) {
...
var10 = "*** NITVM STOPPING : ";
var11 = standard___standard__NativeString___to_s_with_length(var10, 21l);
var9 = var11;
varonce8 = var9;
}
{
...
var14 = 1; /* easy <var_time0:Int> isa OTHER*/
if (unlikely(!var14)) {
var_class_name = type_standard__Int.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_standard__kernel, 435);
fatal_exit(1);
}
var15 = var_time1 - var_time0;
var12 = var15;
goto RET_LABEL13;
RET_LABEL13:(void)0;
}
...
var21 = NEW_standard__NativeArray(3l, &type_standard__NativeArray__standard__Object);
((struct instance_standard__NativeArray*)var21)->values[0] = (val*) var9;
var22 = (val*)(var12<<2|1);
((struct instance_standard__NativeArray*)var21)->values[1] = (val*) var22;
((struct instance_standard__NativeArray*)var21)->values[2] = (val*) var17;
{
((void(*)(val* self, val* p0, long p1))(var20->class->vft[COLOR_standard__array__Array__with_native]))(var20, var21, 3l); /* with_native on <var20:Array[Object]>*/
}
}
{
...
/* method vm#VirtualMachine#ph for (self: VirtualMachine): Perfecthashing */
val* nit___nit__VirtualMachine___ph(val* self) {
val* var /* : Perfecthashing */;
val* var1 /* : Perfecthashing */;
var1 = self->attrs[COLOR_nit__vm__VirtualMachine___ph].val; /* _ph on <self:VirtualMachine> */
...
self->attrs[COLOR_nit__vm__VirtualMachine___ph].val = p0; /* _ph on <self:VirtualMachine> */
RET_LABEL:;
}
/* method vm#VirtualMachine#memory_manager for (self: VirtualMachine): MemoryManager */
val* nit___nit__VirtualMachine___memory_manager(val* self) {
val* var /* : MemoryManager */;
val* var1 /* : MemoryManager */;
var1 = self->attrs[COLOR_nit__vm__VirtualMachine___memory_manager].val; /* _memory_manager on <self:VirtualMachine> */
if (unlikely(var1 == NULL)) {
...
self->attrs[COLOR_nit__vm__VirtualMachine___memory_manager].val = p0; /* _memory_manager on <self:VirtualMachine> */
RET_LABEL:;
}
/* method vm#VirtualMachine#initialization_value for (self: VirtualMachine): Instance */
val* nit___nit__VirtualMachine___initialization_value(val* self) {
val* var /* : Instance */;
val* var1 /* : Instance */;
var1 = self->attrs[COLOR_nit__vm__VirtualMachine___initialization_value].val; /* _initialization_value on <self:VirtualMachine> */
if (unlikely(var1 == NULL)) {
...
self->attrs[COLOR_nit__vm__VirtualMachine___initialization_value].val = p0; /* _initialization_value on <self:VirtualMachine> */
RET_LABEL:;
}
/* method vm#VirtualMachine#init for (self: VirtualMachine) */
...
{
((void(*)(val* self, val* p0))(var->class->vft[COLOR_nit__vm__MInitType__model_61d]))(var, var2); /* model= on <var:MInitType>*/
}
{
...
{
((void(*)(val* self, val* p0))(self->class->vft[COLOR_nit__vm__VirtualMachine__initialization_value_61d]))(self, var3); /* initialization_value= on <self:VirtualMachine>*/
}
{
...
/* method vm#VirtualMachine#is_subtype for (self: VirtualMachine, MType, MType): Bool */
...
val* var83 /* : MClass */;
val* var84 /* : nullable VTable */;
long var85 /* : Int */;
long var_mask /* var mask: Int */;
val* var86 /* : MClass */;
val* var87 /* : nullable VTable */;
val* var88 /* : Pointer */;
...
cltype9 = type_nit__MParameterType.color;
idtype10 = type_nit__MParameterType.id;
if(cltype9 >= var_sub->type->table_size) {
var8 = 0;
} else {
var8 = var_sub->type->type_table[cltype9] == idtype10;
}
var_ = var8;
if (var8){
var7 = var_;
...
cltype12 = type_nit__MVirtualType.color;
idtype13 = type_nit__MVirtualType.id;
if(cltype12 >= var_sub->type->table_size) {
var11 = 0;
} else {
var11 = var_sub->type->type_table[cltype12] == idtype13;
}
var7 = var11;
}
if (var7){
{
var14 = ((val*(*)(val* self))(var_anchor->class->vft[COLOR_nit__model__MClassType__mclass]))(var_anchor); /* mclass on <var_anchor:MClassType>*/
}
{
var15 = ((val*(*)(val* self))(var14->class->vft[COLOR_nit__model__MClass__mclass_type]))(var14); /* mclass_type on <var14:MClass>*/
}
{
var16 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__naive_interpreter__NaiveInterpreter__mainmodule]))(self); /* mainmodule on <self:VirtualMachine>*/
}
{
var17 = ((val*(*)(val* self, val* p0, val* p1, val* p2, short int p3))(var_sub->class->vft[COLOR_nit__model__MType__resolve_for]))(var_sub, var15, var_anchor, var16, 0); /* resolve_for on <var_sub:MType>*/
}
var_sub = var17;
} else {
}
/* <var_sup:MType> isa MParameterType */
cltype20 = type_nit__MParameterType.color;
idtype21 = type_nit__MParameterType.id;
if(cltype20 >= var_sup->type->table_size) {
var19 = 0;
} else {
var19 = var_sup->type->type_table[cltype20] == idtype21;
}
var_22 = var19;
if (var19){
var18 = var_22;
...
cltype24 = type_nit__MVirtualType.color;
idtype25 = type_nit__MVirtualType.id;
if(cltype24 >= var_sup->type->table_size) {
var23 = 0;
} else {
var23 = var_sup->type->type_table[cltype24] == idtype25;
}
var18 = var23;
}
if (var18){
{
var26 = ((val*(*)(val* self))(var_anchor->class->vft[COLOR_nit__model__MClassType__mclass]))(var_anchor); /* mclass on <var_anchor:MClassType>*/
}
{
var27 = ((val*(*)(val* self))(var26->class->vft[COLOR_nit__model__MClass__mclass_type]))(var26); /* mclass_type on <var26:MClass>*/
}
{
var28 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__naive_interpreter__NaiveInterpreter__mainmodule]))(self); /* mainmodule on <self:VirtualMachine>*/
}
{
var29 = ((val*(*)(val* self, val* p0, val* p1, val* p2, short int p3))(var_sup->class->vft[COLOR_nit__model__MType__resolve_for]))(var_sup, var27, var_anchor, var28, 0); /* resolve_for on <var_sup:MType>*/
}
var_sup = var29;
} else {
}
...
{
var33 = ((val*(*)(val* self))(var_sup->class->vft[COLOR_nit__model__MNullableType__mtype]))(var_sup); /* mtype on <var_sup:MType(MNullableType)>*/
}
var_sup = var33;
} else {
/* <var_sup:MType> isa MNullType */
cltype35 = type_nit__MNullType.color;
idtype36 = type_nit__MNullType.id;
if(cltype35 >= var_sup->type->table_size) {
var34 = 0;
} else {
var34 = var_sup->type->type_table[cltype35] == idtype36;
}
if (var34){
var_sup_accept_null = 1;
} else {
...
cltype38 = type_nit__MNullableType.color;
idtype39 = type_nit__MNullableType.id;
if(cltype38 >= var_sub->type->table_size) {
var37 = 0;
} else {
var37 = var_sub->type->type_table[cltype38] == idtype39;
}
if (var37){
var40 = !var_sup_accept_null;
if (var40){
var = 0;
goto RET_LABEL;
} else {
...
{
var41 = ((val*(*)(val* self))(var_sub->class->vft[COLOR_nit__model__MNullableType__mtype]))(var_sub); /* mtype on <var_sub:MType(MNullableType)>*/
}
var_sub = var41;
} else {
...
/* <var_sub:MType> isa MVirtualType */
cltype51 = type_nit__MVirtualType.color;
idtype52 = type_nit__MVirtualType.id;
if(cltype51 >= var_sub->type->table_size) {
var50 = 0;
} else {
var50 = var_sub->type->type_table[cltype51] == idtype52;
}
var45 = var50;
}
if (var45){
{
var53 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__naive_interpreter__NaiveInterpreter__mainmodule]))(self); /* mainmodule on <self:VirtualMachine>*/
}
{
var54 = ((val*(*)(val* self, val* p0, val* p1))(var_sub->class->vft[COLOR_nit__model__MType__anchor_to]))(var_sub, var53, var_anchor); /* anchor_to on <var_sub:MType>*/
}
var_sub = var54;
/* <var_sub:MType> isa MNullableType */
cltype56 = type_nit__MNullableType.color;
idtype57 = type_nit__MNullableType.id;
...
{
var59 = ((val*(*)(val* self))(var_sub->class->vft[COLOR_nit__model__MNullableType__mtype]))(var_sub); /* mtype on <var_sub:MType(MNullableType)>*/
}
var_sub = var59;
} else {
/* <var_sub:MType> isa MNullType */
cltype61 = type_nit__MNullType.color;
idtype62 = type_nit__MNullType.id;
if(cltype61 >= var_sub->type->table_size) {
var60 = 0;
} else {
var60 = var_sub->type->type_table[cltype61] == idtype62;
}
if (var60){
var = var_sup_accept_null;
goto RET_LABEL;
...
cltype64 = type_nit__MClassType.color;
idtype65 = type_nit__MClassType.id;
if(cltype64 >= var_sub->type->table_size) {
var63 = 0;
} else {
var63 = var_sub->type->type_table[cltype64] == idtype65;
}
if (unlikely(!var63)) {
...
/* <var_sup:MType> isa MNullType */
cltype67 = type_nit__MNullType.color;
idtype68 = type_nit__MNullType.id;
if(cltype67 >= var_sup->type->table_size) {
var66 = 0;
} else {
var66 = var_sup->type->type_table[cltype67] == idtype68;
}
if (var66){
var = 0;
goto RET_LABEL;
...
cltype70 = type_nit__MClassType.color;
idtype71 = type_nit__MClassType.id;
if(cltype70 >= var_sup->type->table_size) {
var69 = 0;
} else {
var69 = var_sup->type->type_table[cltype70] == idtype71;
}
if (unlikely(!var69)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 106);
...
{
var72 = ((val*(*)(val* self))(var_sup->class->vft[COLOR_nit__model__MClassType__mclass]))(var_sup); /* mclass on <var_sup:MType(MClassType)>*/
}
{
var73 = ((short int(*)(val* self))(var72->class->vft[COLOR_nit__vm__MClass__loaded]))(var72); /* loaded on <var72:MClass>*/
}
var74 = !var73;
if (var74){
{
var75 = ((val*(*)(val* self))(var_sup->class->vft[COLOR_nit__model__MClassType__mclass]))(var_sup); /* mclass on <var_sup:MType(MClassType)>*/
}
{
((void(*)(val* self, val* p0))(self->class->vft[COLOR_nit__vm__VirtualMachine__create_class]))(self, var75); /* create_class on <self:VirtualMachine>*/
}
} else {
}
{
var76 = ((val*(*)(val* self))(var_sub->class->vft[COLOR_nit__model__MClassType__mclass]))(var_sub); /* mclass on <var_sub:MType(MClassType)>*/
}
{
var77 = ((short int(*)(val* self))(var76->class->vft[COLOR_nit__vm__MClass__loaded]))(var76); /* loaded on <var76:MClass>*/
}
var78 = !var77;
if (var78){
{
var79 = ((val*(*)(val* self))(var_sub->class->vft[COLOR_nit__model__MClassType__mclass]))(var_sub); /* mclass on <var_sub:MType(MClassType)>*/
}
{
((void(*)(val* self, val* p0))(self->class->vft[COLOR_nit__vm__VirtualMachine__create_class]))(self, var79); /* create_class on <self:VirtualMachine>*/
}
} else {
}
{
var80 = ((val*(*)(val* self))(var_sup->class->vft[COLOR_nit__model__MClassType__mclass]))(var_sup); /* mclass on <var_sup:MType(MClassType)>*/
}
{
var81 = ((val*(*)(val* self))(var80->class->vft[COLOR_nit__vm__MClass__vtable]))(var80); /* vtable on <var80:MClass>*/
}
if (var81 == NULL) {
...
var82 = ((long(*)(val* self))(var81->class->vft[COLOR_nit__vm__VTable__id]))(var81); /* id on <var81:nullable VTable>*/
}
var_super_id = var82;
{
var83 = ((val*(*)(val* self))(var_sub->class->vft[COLOR_nit__model__MClassType__mclass]))(var_sub); /* mclass on <var_sub:MType(MClassType)>*/
}
{
var84 = ((val*(*)(val* self))(var83->class->vft[COLOR_nit__vm__MClass__vtable]))(var83); /* vtable on <var83:MClass>*/
}
if (var84 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 114);
...
var85 = ((long(*)(val* self))(var84->class->vft[COLOR_nit__vm__VTable__mask]))(var84); /* mask on <var84:nullable VTable>*/
}
var_mask = var85;
{
var86 = ((val*(*)(val* self))(var_sub->class->vft[COLOR_nit__model__MClassType__mclass]))(var_sub); /* mclass on <var_sub:MType(MClassType)>*/
}
{
var87 = ((val*(*)(val* self))(var86->class->vft[COLOR_nit__vm__MClass__vtable]))(var86); /* vtable on <var86:MClass>*/
}
if (var87 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 116);
...
var88 = ((val*(*)(val* self))(var87->class->vft[COLOR_nit__vm__VTable__internal_vtable]))(var87); /* internal_vtable on <var87:nullable VTable>*/
}
{
var89 = ((short int(*)(val* self, long p0, long p1, val* p2))(self->class->vft[COLOR_nit__vm__VirtualMachine__inter_is_subtype_ph]))(self, var_super_id, var_mask, var88); /* inter_is_subtype_ph on <self:VirtualMachine>*/
}
var_res = var89;
{
...
cltype94 = type_nit__MGenericType.color;
idtype95 = type_nit__MGenericType.id;
...
{
var97 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__naive_interpreter__NaiveInterpreter__mainmodule]))(self); /* mainmodule on <self:VirtualMachine>*/
}
{
var98 = ((val*(*)(val* self))(var_sup->class->vft[COLOR_nit__model__MClassType__mclass]))(var_sup); /* mclass on <var_sup:MType(MGenericType)>*/
}
{
var99 = ((val*(*)(val* self, val* p0, val* p1, val* p2))(var_sub->class->vft[COLOR_nit__model__MType__supertype_to]))(var_sub, var97, var_anchor, var98); /* supertype_to on <var_sub:MType(MClassType)>*/
}
var_sub2 = var99;
var_i = 0l;
{
var100 = ((val*(*)(val* self))(var_sup->class->vft[COLOR_nit__model__MClassType__mclass]))(var_sup); /* mclass on <var_sup:MType(MGenericType)>*/
}
{
var101 = ((long(*)(val* self))(var100->class->vft[COLOR_nit__model__MClass__arity]))(var100); /* arity on <var100:MClass>*/
}
var_102 = var101;
for(;;) {
{
{ /* Inline kernel#Int#< (var_i,var_102) on <var_i:Int> */
...
if (var103){
{
var110 = ((val*(*)(val* self))(var_sub2->class->vft[COLOR_nit__model__MClassType__arguments]))(var_sub2); /* arguments on <var_sub2:MClassType>*/
}
{
var111 = ((val*(*)(val* self, long p0))(var110->class->vft[COLOR_standard__abstract_collection__SequenceRead___91d_93d]))(var110, var_i); /* [] on <var110:Array[MType]>*/
}
var_sub_arg = var111;
{
var112 = ((val*(*)(val* self))(var_sup->class->vft[COLOR_nit__model__MClassType__arguments]))(var_sup); /* arguments on <var_sup:MType(MGenericType)>*/
}
{
var113 = ((val*(*)(val* self, long p0))(var112->class->vft[COLOR_standard__abstract_collection__SequenceRead___91d_93d]))(var112, var_i); /* [] on <var112:Array[MType]>*/
}
var_sup_arg = var113;
{
var114 = ((short int(*)(val* self, val* p0, val* p1))(self->class->vft[COLOR_nit__naive_interpreter__NaiveInterpreter__is_subtype]))(self, var_sub_arg, var_sup_arg); /* is_subtype on <self:VirtualMachine>*/
}
var_res2 = var114;
{
...
var118 = standard___standard__Int___Discrete__successor(var_i, 1l);
var_i = var118;
} else {
goto BREAK_label;
}
...
/* method vm#VirtualMachine#inter_is_subtype_ph for (self: VirtualMachine, Int, Int, Pointer): Bool */
...
var1 = vm___VirtualMachine_inter_is_subtype_ph___impl(var_for_c_0, p0, p1, var2);
var = var1;
goto RET_LABEL;
RET_LABEL:;
return var;
}
/* method vm#VirtualMachine#inter_is_subtype_sst for (self: VirtualMachine, Int, Int, Pointer): Bool */
...
var_for_c_0 = nit_alloc(sizeof(struct nitni_instance));
var_for_c_0->value = self;
var1 = vm___VirtualMachine_inter_is_subtype_sst___impl(var_for_c_0, p0, p1, var2);
var = var1;
goto RET_LABEL;
RET_LABEL:;
return var;
}
/* method vm#VirtualMachine#init_instance for (self: VirtualMachine, Instance) */
...
{
var3 = ((short int(*)(val* self))(var2->class->vft[COLOR_nit__vm__MClass__loaded]))(var2); /* loaded on <var2:MClass>*/
}
var4 = !var3;
if (var4){
{
...
{
((void(*)(val* self, val* p0))(self->class->vft[COLOR_nit__vm__VirtualMachine__create_class]))(self, var10); /* create_class on <self:VirtualMachine>*/
}
} else {
}
{
...
{
var17 = ((val*(*)(val* self))(var16->class->vft[COLOR_nit__vm__MClass__vtable]))(var16); /* vtable on <var16:MClass>*/
}
{
((void(*)(val* self, val* p0))(var_recv->class->vft[COLOR_nit__vm__Instance__vtable_61d]))(var_recv, var17); /* vtable= on <var_recv:Instance>*/
}
...
{
var21 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__VirtualMachine__initialization_value]))(self); /* initialization_value on <self:VirtualMachine>*/
}
{
...
{
var28 = ((val*(*)(val* self))(var27->class->vft[COLOR_nit__vm__MClass__mattributes]))(var27); /* mattributes on <var27:MClass>*/
}
{
...
{
var30 = ((val*(*)(val* self, val* p0, long p1))(self->class->vft[COLOR_nit__vm__VirtualMachine__init_internal_attributes]))(self, var21, var29); /* init_internal_attributes on <self:VirtualMachine>*/
}
{
((void(*)(val* self, val* p0))(var_recv->class->vft[COLOR_nit__vm__MutableInstance__internal_attributes_61d]))(var_recv, var30); /* internal_attributes= on <var_recv:Instance(MutableInstance)>*/
}
{
...
/* method vm#VirtualMachine#init_instance_primitive for (self: VirtualMachine, Instance) */
...
/* method vm#VirtualMachine#init_internal_attributes for (self: VirtualMachine, Instance, Int): Pointer */
...
var1 = vm___VirtualMachine_init_internal_attributes___impl(var_for_c_0, var_for_c_1, p1);
...
long vm___Array_of_Instance_length( struct nitni_instance * recv ) {
long var /* : Int */;
{
...
struct nitni_instance * vm___Array_of_Instance__index( struct nitni_instance * recv, long index ) {
...
/* method vm#VirtualMachine#create_class for (self: VirtualMachine, MClass) */
void nit___nit__VirtualMachine___create_class(val* self, val* p0) {
val* var_mclass /* var mclass: MClass */;
var_mclass = p0;
{
((void(*)(val* self, val* p0))(var_mclass->class->vft[COLOR_nit__vm__MClass__make_vt]))(var_mclass, self); /* make_vt on <var_mclass:MClass>*/
}
RET_LABEL:;
}
/* method vm#VirtualMachine#send for (self: VirtualMachine, MMethod, Array[Instance]): nullable Instance */
...
{
var6 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__Instance__vtable]))(var_recv); /* vtable on <var_recv:Instance>*/
}
...
{
var7 = ((val*(*)(val* self, val* p0, val* p1, val* p2))(self->class->vft[COLOR_nit__vm__VirtualMachine__method_dispatch]))(self, var_mproperty, var6, var_recv); /* method_dispatch on <self:VirtualMachine>*/
}
var_propdef = var7;
{
...
/* method vm#VirtualMachine#method_dispatch for (self: VirtualMachine, MMethod, VTable, Instance): MMethodDef */
...
{
var3 = ((val*(*)(val* self))(var2->class->vft[COLOR_nit__vm__MClass__positions_methods]))(var2); /* positions_methods on <var2:MClass>*/
}
{
...
if (var11){
{
var16 = ((val*(*)(val* self))(var_vtable->class->vft[COLOR_nit__vm__VTable__internal_vtable]))(var_vtable); /* internal_vtable on <var_vtable:VTable>*/
}
{
var17 = ((long(*)(val* self))(var_mproperty->class->vft[COLOR_nit__vm__MMethod__absolute_offset]))(var_mproperty); /* absolute_offset on <var_mproperty:MMethod>*/
}
{
var18 = ((val*(*)(val* self, val* p0, long p1))(self->class->vft[COLOR_nit__vm__VirtualMachine__method_dispatch_sst]))(self, var16, var17); /* method_dispatch_sst on <self:VirtualMachine>*/
}
var = var18;
goto RET_LABEL;
} else {
{
var19 = ((val*(*)(val* self))(var_vtable->class->vft[COLOR_nit__vm__VTable__internal_vtable]))(var_vtable); /* internal_vtable on <var_vtable:VTable>*/
}
{
var20 = ((long(*)(val* self))(var_vtable->class->vft[COLOR_nit__vm__VTable__mask]))(var_vtable); /* mask on <var_vtable:VTable>*/
}
{
...
{
var23 = ((val*(*)(val* self))(var22->class->vft[COLOR_nit__vm__MClass__vtable]))(var22); /* vtable on <var22:MClass>*/
}
if (var23 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 220);
...
var24 = ((long(*)(val* self))(var23->class->vft[COLOR_nit__vm__VTable__id]))(var23); /* id on <var23:nullable VTable>*/
}
{
var25 = ((long(*)(val* self))(var_mproperty->class->vft[COLOR_nit__vm__MMethod__offset]))(var_mproperty); /* offset on <var_mproperty:MMethod>*/
}
{
var26 = ((val*(*)(val* self, val* p0, long p1, long p2, long p3))(self->class->vft[COLOR_nit__vm__VirtualMachine__method_dispatch_ph]))(self, var19, var20, var24, var25); /* method_dispatch_ph on <self:VirtualMachine>*/
}
var = var26;
goto RET_LABEL;
}
...
/* method vm#VirtualMachine#method_dispatch_ph for (self: VirtualMachine, Pointer, Int, Int, Int): MMethodDef */
...
ret_var = vm___VirtualMachine_method_dispatch_ph___impl(var_for_c_0, var2, p1, p2, p3);
var1 = ret_var->value;
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
/* method vm#VirtualMachine#method_dispatch_sst for (self: VirtualMachine, Pointer, Int): MMethodDef */
...
var_for_c_0->value = self;
struct nitni_instance* ret_var;
ret_var = vm___VirtualMachine_method_dispatch_sst___impl(var_for_c_0, var2, p1);
var1 = ret_var->value;
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
/* method vm#VirtualMachine#read_attribute for (self: VirtualMachine, MAttribute, Instance): Instance */
...
{
var4 = ((val*(*)(val* self))(var3->class->vft[COLOR_nit__vm__MClass__positions_attributes]))(var3); /* positions_attributes on <var3:MClass>*/
}
{
...
if (var14){
{
var19 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__MutableInstance__internal_attributes]))(var_recv); /* internal_attributes on <var_recv:Instance(MutableInstance)>*/
}
{
var20 = ((long(*)(val* self))(var_mproperty->class->vft[COLOR_nit__vm__MAttribute__absolute_offset]))(var_mproperty); /* absolute_offset on <var_mproperty:MAttribute>*/
}
{
var21 = ((val*(*)(val* self, val* p0, long p1))(self->class->vft[COLOR_nit__vm__VirtualMachine__read_attribute_sst]))(self, var19, var20); /* read_attribute_sst on <self:VirtualMachine>*/
}
var_i = var21;
} else {
{
...
{
var24 = ((val*(*)(val* self))(var23->class->vft[COLOR_nit__vm__MClass__vtable]))(var23); /* vtable on <var23:MClass>*/
}
if (var24 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 264);
...
var25 = ((long(*)(val* self))(var24->class->vft[COLOR_nit__vm__VTable__id]))(var24); /* id on <var24:nullable VTable>*/
}
var_id = var25;
{
var26 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__MutableInstance__internal_attributes]))(var_recv); /* internal_attributes on <var_recv:Instance(MutableInstance)>*/
}
{
var27 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__Instance__vtable]))(var_recv); /* vtable on <var_recv:Instance(MutableInstance)>*/
}
if (var27 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 266);
...
var28 = ((val*(*)(val* self))(var27->class->vft[COLOR_nit__vm__VTable__internal_vtable]))(var27); /* internal_vtable on <var27:nullable VTable>*/
}
{
var29 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__Instance__vtable]))(var_recv); /* vtable on <var_recv:Instance(MutableInstance)>*/
}
if (var29 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 267);
...
var30 = ((long(*)(val* self))(var29->class->vft[COLOR_nit__vm__VTable__mask]))(var29); /* mask on <var29:nullable VTable>*/
}
{
var31 = ((long(*)(val* self))(var_mproperty->class->vft[COLOR_nit__vm__MAttribute__offset]))(var_mproperty); /* offset on <var_mproperty:MAttribute>*/
}
{
var32 = ((val*(*)(val* self, val* p0, val* p1, long p2, long p3, long p4))(self->class->vft[COLOR_nit__vm__VirtualMachine__read_attribute_ph]))(self, var26, var28, var30, var_id, var31); /* read_attribute_ph on <self:VirtualMachine>*/
}
var_i = var32;
}
{
var33 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__VirtualMachine__initialization_value]))(self); /* initialization_value on <self:VirtualMachine>*/
}
{
...
var36 = "Uninitialized attribute ";
var37 = standard___standard__NativeString___to_s_with_length(var36, 24l);
var35 = var37;
varonce = var35;
}
{
var38 = ((val*(*)(val* self))(var_mproperty->class->vft[COLOR_nit__model_base__MEntity__name]))(var_mproperty); /* name on <var_mproperty:MAttribute>*/
}
var39 = NEW_standard__Array(&type_standard__Array__standard__Object);
{ /* var39 = array_instance Array[Object] */
var40 = NEW_standard__NativeArray(2l, &type_standard__NativeArray__standard__Object);
((struct instance_standard__NativeArray*)var40)->values[0] = (val*) var35;
((struct instance_standard__NativeArray*)var40)->values[1] = (val*) var38;
{
((void(*)(val* self, val* p0, long p1))(var39->class->vft[COLOR_standard__array__Array__with_native]))(var39, var40, 2l); /* with_native on <var39:Array[Object]>*/
}
}
{
var41 = ((val*(*)(val* self))(var39->class->vft[COLOR_standard__string__Object__to_s]))(var39); /* to_s on <var39:Array[Object]>*/
}
{
...
/* method vm#VirtualMachine#read_attribute_ph for (self: VirtualMachine, Pointer, Pointer, Int, Int, Int): Instance */
...
var_for_c_0->value = self;
struct nitni_instance* ret_var;
ret_var = vm___VirtualMachine_read_attribute_ph___impl(var_for_c_0, var2, var3, p2, p3, p4);
var1 = ret_var->value;
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
/* method vm#VirtualMachine#read_attribute_sst for (self: VirtualMachine, Pointer, Int): Instance */
...
var_for_c_0->value = self;
struct nitni_instance* ret_var;
ret_var = vm___VirtualMachine_read_attribute_sst___impl(var_for_c_0, var2, p1);
var1 = ret_var->value;
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
/* method vm#VirtualMachine#write_attribute for (self: VirtualMachine, MAttribute, Instance, Instance) */
...
{
var3 = ((val*(*)(val* self))(var2->class->vft[COLOR_nit__vm__MClass__positions_attributes]))(var2); /* positions_attributes on <var2:MClass>*/
}
{
...
if (var13){
{
var18 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__MutableInstance__internal_attributes]))(var_recv); /* internal_attributes on <var_recv:Instance(MutableInstance)>*/
}
{
var19 = ((long(*)(val* self))(var_mproperty->class->vft[COLOR_nit__vm__MAttribute__absolute_offset]))(var_mproperty); /* absolute_offset on <var_mproperty:MAttribute>*/
}
{
((void(*)(val* self, val* p0, long p1, val* p2))(self->class->vft[COLOR_nit__vm__VirtualMachine__write_attribute_sst]))(self, var18, var19, var_value); /* write_attribute_sst on <self:VirtualMachine>*/
}
} else {
{
...
{
var22 = ((val*(*)(val* self))(var21->class->vft[COLOR_nit__vm__MClass__vtable]))(var21); /* vtable on <var21:MClass>*/
}
if (var22 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 321);
...
var23 = ((long(*)(val* self))(var22->class->vft[COLOR_nit__vm__VTable__id]))(var22); /* id on <var22:nullable VTable>*/
}
var_id = var23;
{
var24 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__MutableInstance__internal_attributes]))(var_recv); /* internal_attributes on <var_recv:Instance(MutableInstance)>*/
}
{
var25 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__Instance__vtable]))(var_recv); /* vtable on <var_recv:Instance(MutableInstance)>*/
}
if (var25 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 323);
...
var26 = ((val*(*)(val* self))(var25->class->vft[COLOR_nit__vm__VTable__internal_vtable]))(var25); /* internal_vtable on <var25:nullable VTable>*/
}
{
var27 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__Instance__vtable]))(var_recv); /* vtable on <var_recv:Instance(MutableInstance)>*/
}
...
var28 = ((long(*)(val* self))(var27->class->vft[COLOR_nit__vm__VTable__mask]))(var27); /* mask on <var27:nullable VTable>*/
}
{
var29 = ((long(*)(val* self))(var_mproperty->class->vft[COLOR_nit__vm__MAttribute__offset]))(var_mproperty); /* offset on <var_mproperty:MAttribute>*/
}
{
((void(*)(val* self, val* p0, val* p1, long p2, long p3, long p4, val* p5))(self->class->vft[COLOR_nit__vm__VirtualMachine__write_attribute_ph]))(self, var24, var26, var28, var_id, var29, var_value); /* write_attribute_ph on <self:VirtualMachine>*/
}
}
RET_LABEL:;
}
/* method vm#VirtualMachine#write_attribute_ph for (self: VirtualMachine, Pointer, Pointer, Int, Int, Int, Instance) */
...
vm___VirtualMachine_write_attribute_ph___impl(var_for_c_0, var, var1, p2, p3, p4, var_for_c_6);
RET_LABEL:;
}
/* method vm#VirtualMachine#write_attribute_sst for (self: VirtualMachine, Pointer, Int, Instance) */
...
vm___VirtualMachine_write_attribute_sst___impl(var_for_c_0, var, p1, var_for_c_3);
RET_LABEL:;
}
/* method vm#VirtualMachine#isset_attribute for (self: VirtualMachine, MAttribute, Instance): Bool */
...
{
var4 = ((val*(*)(val* self))(var3->class->vft[COLOR_nit__vm__MClass__vtable]))(var3); /* vtable on <var3:MClass>*/
}
if (var4 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 364);
...
var5 = ((long(*)(val* self))(var4->class->vft[COLOR_nit__vm__VTable__id]))(var4); /* id on <var4:nullable VTable>*/
}
var_id = var5;
{
var6 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__MutableInstance__internal_attributes]))(var_recv); /* internal_attributes on <var_recv:Instance(MutableInstance)>*/
}
{
var7 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__Instance__vtable]))(var_recv); /* vtable on <var_recv:Instance(MutableInstance)>*/
}
if (var7 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 366);
...
var8 = ((val*(*)(val* self))(var7->class->vft[COLOR_nit__vm__VTable__internal_vtable]))(var7); /* internal_vtable on <var7:nullable VTable>*/
}
{
var9 = ((val*(*)(val* self))(var_recv->class->vft[COLOR_nit__vm__Instance__vtable]))(var_recv); /* vtable on <var_recv:Instance(MutableInstance)>*/
}
if (var9 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 367);
...
var10 = ((long(*)(val* self))(var9->class->vft[COLOR_nit__vm__VTable__mask]))(var9); /* mask on <var9:nullable VTable>*/
}
{
var11 = ((long(*)(val* self))(var_mproperty->class->vft[COLOR_nit__vm__MAttribute__offset]))(var_mproperty); /* offset on <var_mproperty:MAttribute>*/
}
{
var12 = ((val*(*)(val* self, val* p0, val* p1, long p2, long p3, long p4))(self->class->vft[COLOR_nit__vm__VirtualMachine__read_attribute_ph]))(self, var6, var8, var10, var_id, var11); /* read_attribute_ph on <self:VirtualMachine>*/
}
var_i = var12;
{
var13 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__VirtualMachine__initialization_value]))(self); /* initialization_value on <self:VirtualMachine>*/
}
{
...
/* method vm#MClass#vtable for (self: MClass): nullable VTable */
val* nit__vm___MClass___vtable(val* self) {
val* var /* : nullable VTable */;
val* var1 /* : nullable VTable */;
var1 = self->attrs[COLOR_nit__vm__MClass___vtable].val; /* _vtable on <self:MClass> */
var = var1;
RET_LABEL:;
return var;
}
/* method vm#MClass#vtable= for (self: MClass, nullable VTable) */
void nit__vm___MClass___vtable_61d(val* self, val* p0) {
self->attrs[COLOR_nit__vm__MClass___vtable].val = p0; /* _vtable on <self:MClass> */
RET_LABEL:;
}
/* method vm#MClass#loaded for (self: MClass): Bool */
short int nit__vm___MClass___loaded(val* self) {
short int var /* : Bool */;
short int var1 /* : Bool */;
var1 = self->attrs[COLOR_nit__vm__MClass___loaded].s; /* _loaded on <self:MClass> */
var = var1;
RET_LABEL:;
return var;
}
/* method vm#MClass#loaded= for (self: MClass, Bool) */
void nit__vm___MClass___loaded_61d(val* self, short int p0) {
self->attrs[COLOR_nit__vm__MClass___loaded].s = p0; /* _loaded on <self:MClass> */
RET_LABEL:;
}
/* method vm#MClass#color for (self: MClass): Int */
long nit__vm___MClass___color(val* self) {
long var /* : Int */;
long var1 /* : Int */;
var1 = self->attrs[COLOR_nit__vm__MClass___color].l; /* _color on <self:MClass> */
var = var1;
RET_LABEL:;
return var;
}
/* method vm#MClass#color= for (self: MClass, Int) */
void nit__vm___MClass___color_61d(val* self, long p0) {
self->attrs[COLOR_nit__vm__MClass___color].l = p0; /* _color on <self:MClass> */
RET_LABEL:;
}
/* method vm#MClass#positions_attributes for (self: MClass): HashMap[MClass, Int] */
val* nit__vm___MClass___positions_attributes(val* self) {
val* var /* : HashMap[MClass, Int] */;
val* var1 /* : HashMap[MClass, Int] */;
var1 = self->attrs[COLOR_nit__vm__MClass___positions_attributes].val; /* _positions_attributes on <self:MClass> */
if (unlikely(var1 == NULL)) {
...
/* method vm#MClass#positions_attributes= for (self: MClass, HashMap[MClass, Int]) */
void nit__vm___MClass___positions_attributes_61d(val* self, val* p0) {
self->attrs[COLOR_nit__vm__MClass___positions_attributes].val = p0; /* _positions_attributes on <self:MClass> */
RET_LABEL:;
}
/* method vm#MClass#positions_methods for (self: MClass): HashMap[MClass, Int] */
val* nit__vm___MClass___positions_methods(val* self) {
val* var /* : HashMap[MClass, Int] */;
val* var1 /* : HashMap[MClass, Int] */;
var1 = self->attrs[COLOR_nit__vm__MClass___positions_methods].val; /* _positions_methods on <self:MClass> */
if (unlikely(var1 == NULL)) {
...
/* method vm#MClass#positions_methods= for (self: MClass, HashMap[MClass, Int]) */
void nit__vm___MClass___positions_methods_61d(val* self, val* p0) {
self->attrs[COLOR_nit__vm__MClass___positions_methods].val = p0; /* _positions_methods on <self:MClass> */
RET_LABEL:;
}
/* method vm#MClass#intro_mattributes for (self: MClass): Array[MAttribute] */
val* nit__vm___MClass___intro_mattributes(val* self) {
val* var /* : Array[MAttribute] */;
val* var1 /* : Array[MAttribute] */;
var1 = self->attrs[COLOR_nit__vm__MClass___intro_mattributes].val; /* _intro_mattributes on <self:MClass> */
if (unlikely(var1 == NULL)) {
...
/* method vm#MClass#intro_mattributes= for (self: MClass, Array[MAttribute]) */
void nit__vm___MClass___intro_mattributes_61d(val* self, val* p0) {
self->attrs[COLOR_nit__vm__MClass___intro_mattributes].val = p0; /* _intro_mattributes on <self:MClass> */
RET_LABEL:;
}
/* method vm#MClass#intro_mmethods for (self: MClass): Array[MMethod] */
val* nit__vm___MClass___intro_mmethods(val* self) {
val* var /* : Array[MMethod] */;
val* var1 /* : Array[MMethod] */;
var1 = self->attrs[COLOR_nit__vm__MClass___intro_mmethods].val; /* _intro_mmethods on <self:MClass> */
if (unlikely(var1 == NULL)) {
...
/* method vm#MClass#intro_mmethods= for (self: MClass, Array[MMethod]) */
void nit__vm___MClass___intro_mmethods_61d(val* self, val* p0) {
self->attrs[COLOR_nit__vm__MClass___intro_mmethods].val = p0; /* _intro_mmethods on <self:MClass> */
RET_LABEL:;
}
/* method vm#MClass#mattributes for (self: MClass): Array[MAttribute] */
val* nit__vm___MClass___mattributes(val* self) {
val* var /* : Array[MAttribute] */;
val* var1 /* : Array[MAttribute] */;
var1 = self->attrs[COLOR_nit__vm__MClass___mattributes].val; /* _mattributes on <self:MClass> */
if (unlikely(var1 == NULL)) {
...
/* method vm#MClass#mattributes= for (self: MClass, Array[MAttribute]) */
void nit__vm___MClass___mattributes_61d(val* self, val* p0) {
self->attrs[COLOR_nit__vm__MClass___mattributes].val = p0; /* _mattributes on <self:MClass> */
RET_LABEL:;
}
/* method vm#MClass#mmethods for (self: MClass): Array[MMethod] */
val* nit__vm___MClass___mmethods(val* self) {
val* var /* : Array[MMethod] */;
val* var1 /* : Array[MMethod] */;
var1 = self->attrs[COLOR_nit__vm__MClass___mmethods].val; /* _mmethods on <self:MClass> */
if (unlikely(var1 == NULL)) {
...
/* method vm#MClass#mmethods= for (self: MClass, Array[MMethod]) */
void nit__vm___MClass___mmethods_61d(val* self, val* p0) {
self->attrs[COLOR_nit__vm__MClass___mmethods].val = p0; /* _mmethods on <self:MClass> */
RET_LABEL:;
}
/* method vm#MClass#make_vt for (self: MClass, VirtualMachine) */
void nit__vm___MClass___make_vt(val* self, val* p0) {
...
var_v = p0;
{
var = ((short int(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__loaded]))(self); /* loaded on <self:MClass>*/
}
if (var){
goto RET_LABEL;
} else {
...
{
var1 = ((val*(*)(val* self, val* p0))(self->class->vft[COLOR_nit__vm__MClass__superclasses_ordering]))(self, var_v); /* superclasses_ordering on <self:MClass>*/
}
...
var_parent = var14;
{
var15 = ((short int(*)(val* self))(var_parent->class->vft[COLOR_nit__vm__MClass__loaded]))(var_parent); /* loaded on <var_parent:MClass>*/
}
var16 = !var15;
if (var16){
{
((void(*)(val* self, val* p0))(var_parent->class->vft[COLOR_nit__vm__MClass__make_vt]))(var_parent, var_v); /* make_vt on <var_parent:MClass>*/
}
} else {
}
{
var17 = ((val*(*)(val* self))(var_parent->class->vft[COLOR_nit__vm__MClass__intro_mmethods]))(var_parent); /* intro_mmethods on <var_parent:MClass>*/
}
{
...
var_methods = var18;
{
var19 = ((val*(*)(val* self))(var_parent->class->vft[COLOR_nit__vm__MClass__intro_mattributes]))(var_parent); /* intro_mattributes on <var_parent:MClass>*/
}
{
...
{
var21 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__mmethods]))(self); /* mmethods on <self:MClass>*/
}
{
var22 = ((val*(*)(val* self))(var_parent->class->vft[COLOR_nit__vm__MClass__intro_mmethods]))(var_parent); /* intro_mmethods on <var_parent:MClass>*/
}
{
...
{
var23 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__mattributes]))(self); /* mattributes on <self:MClass>*/
}
{
var24 = ((val*(*)(val* self))(var_parent->class->vft[COLOR_nit__vm__MClass__intro_mattributes]))(var_parent); /* intro_mattributes on <var_parent:MClass>*/
}
{
...
{
var25 = ((val*(*)(val* self))(var_parent->class->vft[COLOR_nit__vm__MClass__vtable]))(var_parent); /* vtable on <var_parent:MClass>*/
}
if (var25 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 440);
...
var26 = ((long(*)(val* self))(var25->class->vft[COLOR_nit__vm__VTable__id]))(var25); /* id on <var25:nullable VTable>*/
}
{
var27 = (val*)(var26<<2|1);
...
{
var36 = ((val*(*)(val* self))(var_previous_parent->class->vft[COLOR_nit__vm__MClass__positions_attributes]))(var_previous_parent); /* positions_attributes on <var_previous_parent:nullable MClass(MClass)>*/
}
{
...
{
var42 = ((val*(*)(val* self))(var_previous_parent->class->vft[COLOR_nit__vm__MClass__positions_methods]))(var_previous_parent); /* positions_methods on <var_previous_parent:nullable MClass(MClass)>*/
}
{
...
{
((void(*)(val* self, long p0, long p1, val* p2))(var_parent->class->vft[COLOR_nit__vm__MClass__update_positions]))(var_parent, var_pos_attr, var_pos_meth, self); /* update_positions on <var_parent:MClass>*/
}
{
...
{
((void(*)(val* self, val* p0, val* p1, val* p2, val* p3, long p4, long p5))(self->class->vft[COLOR_nit__vm__MClass__allocate_vtable]))(self, var_v, var_ids, var_nb_methods, var_nb_attributes, var_offset_attributes, var_offset_methods); /* allocate_vtable on <self:MClass>*/
}
{
((void(*)(val* self, short int p0))(self->class->vft[COLOR_nit__vm__MClass__loaded_61d]))(self, 1); /* loaded= on <self:MClass>*/
}
{
{ /* Inline kernel#Int#- (var_offset_methods,2l) on <var_offset_methods:Int> */
/* Covariant cast for argument 0 (i) <2l:Int> isa OTHER */
...
{
((void(*)(val* self, long p0))(self->class->vft[COLOR_nit__vm__MClass__color_61d]))(self, var69); /* color= on <self:MClass>*/
}
{
...
var_cl = var80;
{
var81 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__vtable]))(self); /* vtable on <self:MClass>*/
}
...
{
((void(*)(val* self, val* p0, val* p1, val* p2))(self->class->vft[COLOR_nit__vm__MClass__fill_vtable]))(self, var_v, var81, var_cl); /* fill_vtable on <self:MClass>*/
}
{
...
/* method vm#MClass#allocate_vtable for (self: MClass, VirtualMachine, Array[Int], Array[Int], Array[Int], Int, Int) */
void nit__vm___MClass___allocate_vtable(val* self, val* p0, val* p1, val* p2, val* p3, long p4, long p5) {
val* var_v /* var v: VirtualMachine */;
val* var_ids /* var ids: Array[Int] */;
val* var_nb_methods /* var nb_methods: Array[Int] */;
val* var_nb_attributes /* var nb_attributes: Array[Int] */;
...
{
((void(*)(val* self, val* p0))(self->class->vft[COLOR_nit__vm__MClass__vtable_61d]))(self, var); /* vtable= on <self:MClass>*/
}
...
var_idc = var1;
{
var2 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__vtable]))(self); /* vtable on <self:MClass>*/
}
{
var3 = ((val*(*)(val* self))(var_v->class->vft[COLOR_nit__vm__VirtualMachine__ph]))(var_v); /* ph on <var_v:VirtualMachine>*/
}
{
...
((void(*)(val* self, long p0))(var2->class->vft[COLOR_nit__vm__VTable__mask_61d]))(var2, var5); /* mask= on <var2:nullable VTable>*/
}
{
var9 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__vtable]))(self); /* vtable on <self:MClass>*/
}
{
...
var11 = (long)(var10)>>2;
((void(*)(val* self, long p0))(var9->class->vft[COLOR_nit__vm__VTable__id_61d]))(var9, var11); /* id= on <var9:nullable VTable>*/
}
{
var12 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__vtable]))(self); /* vtable on <self:MClass>*/
}
{
...
((void(*)(val* self, val* p0))(var12->class->vft[COLOR_nit__vm__VTable__classname_61d]))(var12, var13); /* classname= on <var12:nullable VTable>*/
}
...
{
var15 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__vtable]))(self); /* vtable on <self:MClass>*/
}
if (var15 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 493);
...
var16 = ((long(*)(val* self))(var15->class->vft[COLOR_nit__vm__VTable__id]))(var15); /* id on <var15:nullable VTable>*/
}
{
var17 = (val*)(var16<<2|1);
...
{
((void(*)(val* self, long p0))(var_p->class->vft[COLOR_nit__vm__MMethod__offset_61d]))(var_p, var_relative_offset_meth); /* offset= on <var_p:MProperty(MMethod)>*/
}
{
...
{
((void(*)(val* self, long p0))(var_p->class->vft[COLOR_nit__vm__MMethod__absolute_offset_61d]))(var_p, var41); /* absolute_offset= on <var_p:MProperty(MMethod)>*/
}
{
...
{
var55 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__intro_mmethods]))(self); /* intro_mmethods on <self:MClass>*/
}
{
...
{
((void(*)(val* self, long p0))(var_p->class->vft[COLOR_nit__vm__MAttribute__offset_61d]))(var_p, var_relative_offset_attr); /* offset= on <var_p:MProperty(MAttribute)>*/
}
{
...
{
((void(*)(val* self, long p0))(var_p->class->vft[COLOR_nit__vm__MAttribute__absolute_offset_61d]))(var_p, var66); /* absolute_offset= on <var_p:MProperty(MAttribute)>*/
}
{
...
{
var80 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__intro_mattributes]))(self); /* intro_mattributes on <self:MClass>*/
}
{
...
{
var82 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__mattributes]))(self); /* mattributes on <self:MClass>*/
}
{
var83 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__intro_mattributes]))(self); /* intro_mattributes on <self:MClass>*/
}
{
...
{
var84 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__mmethods]))(self); /* mmethods on <self:MClass>*/
}
{
var85 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__intro_mmethods]))(self); /* intro_mmethods on <self:MClass>*/
}
{
...
{
((void(*)(val* self, long p0, long p1, val* p2))(self->class->vft[COLOR_nit__vm__MClass__update_positions]))(self, var_offset_attributes, var_offset_methods, self); /* update_positions on <self:MClass>*/
}
{
var88 = ((val*(*)(val* self, val* p0))(self->class->vft[COLOR_nit__vm__MClass__calculate_delta]))(self, var_nb_attributes_total); /* calculate_delta on <self:MClass>*/
}
var_deltas = var88;
{
var89 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__vtable]))(self); /* vtable on <self:MClass>*/
}
{
var90 = ((val*(*)(val* self))(var_v->class->vft[COLOR_nit__vm__VirtualMachine__memory_manager]))(var_v); /* memory_manager on <var_v:VirtualMachine>*/
}
{
var91 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__vtable]))(self); /* vtable on <self:MClass>*/
}
if (var91 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 545);
...
var92 = ((long(*)(val* self))(var91->class->vft[COLOR_nit__vm__VTable__mask]))(var91); /* mask on <var91:nullable VTable>*/
}
{
var93 = ((val*(*)(val* self, val* p0, val* p1, val* p2, long p3))(var90->class->vft[COLOR_nit__vm__MemoryManager__init_vtable]))(var90, var_ids_total, var_nb_methods_total, var_deltas, var92); /* init_vtable on <var90:MemoryManager>*/
}
if (var89 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 545);
...
((void(*)(val* self, val* p0))(var89->class->vft[COLOR_nit__vm__VTable__internal_vtable_61d]))(var89, var93); /* internal_vtable= on <var89:nullable VTable>*/
}
RET_LABEL:;
}
/* method vm#MClass#fill_vtable for (self: MClass, VirtualMachine, VTable, MClass) */
void nit__vm___MClass___fill_vtable(val* self, val* p0, val* p1, val* p2) {
val* var_v /* var v: VirtualMachine */;
...
var_methods = var;
{
var1 = ((val*(*)(val* self))(var_cl->class->vft[COLOR_nit__vm__MClass__intro_mmethods]))(var_cl); /* intro_mmethods on <var_cl:MClass>*/
}
var_ = var1;
{
...
{
var10 = ((val*(*)(val* self))(var_v->class->vft[COLOR_nit__vm__VirtualMachine__memory_manager]))(var_v); /* memory_manager on <var_v:VirtualMachine>*/
}
{
var11 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__vtable]))(self); /* vtable on <self:MClass>*/
}
if (var11 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 561);
...
var12 = ((val*(*)(val* self))(var11->class->vft[COLOR_nit__vm__VTable__internal_vtable]))(var11); /* internal_vtable on <var11:nullable VTable>*/
}
{
var13 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__vtable]))(self); /* vtable on <self:MClass>*/
}
if (var13 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 561);
...
var14 = ((long(*)(val* self))(var13->class->vft[COLOR_nit__vm__VTable__mask]))(var13); /* mask on <var13:nullable VTable>*/
}
{
var15 = ((val*(*)(val* self))(var_cl->class->vft[COLOR_nit__vm__MClass__vtable]))(var_cl); /* vtable on <var_cl:MClass>*/
}
if (var15 == NULL) {
PRINT_ERROR("Runtime error: %s", "Receiver is null");
PRINT_ERROR(" (%s:%d)\n", FILE_nit__vm, 561);
...
{
((void(*)(val* self, val* p0, long p1, long p2, val* p3))(var10->class->vft[COLOR_nit__vm__MemoryManager__put_methods]))(var10, var12, var14, var16, var_methods); /* put_methods on <var10:MemoryManager>*/
}
RET_LABEL:;
}
/* method vm#MClass#calculate_delta for (self: MClass, Array[Int]): Array[Int] */
val* nit__vm___MClass___calculate_delta(val* self, val* p0) {
val* var /* : Array[Int] */;
val* var_nb_attributes /* var nb_attributes: Array[Int] */;
val* var1 /* : Array[Int] */;
val* var_deltas /* var deltas: Array[Int] */;
...
/* method vm#MClass#superclasses_ordering for (self: MClass, VirtualMachine): Array[MClass] */
val* nit__vm___MClass___superclasses_ordering(val* self, val* p0) {
...
if (var7){
{
var11 = ((val*(*)(val* self, val* p0, val* p1))(self->class->vft[COLOR_nit__vm__MClass__dfs]))(self, var_v, var_res); /* dfs on <self:MClass>*/
}
var_ordering = var11;
var = var_ordering;
goto RET_LABEL;
...
/* method vm#MClass#dfs for (self: MClass, VirtualMachine, Array[MClass]): Array[MClass] */
val* nit__vm___MClass___dfs(val* self, val* p0, val* p1) {
val* var /* : Array[MClass] */;
val* var_v /* var v: VirtualMachine */;
val* var_res /* var res: Array[MClass] */;
val* var1 /* : MModule */;
...
if (var18){
{
var19 = ((val*(*)(val* self))(var_cl->class->vft[COLOR_nit__vm__MClass__mmethods]))(var_cl); /* mmethods on <var_cl:MClass>*/
}
{
...
{
var21 = ((val*(*)(val* self))(var_cl->class->vft[COLOR_nit__vm__MClass__mattributes]))(var_cl); /* mattributes on <var_cl:MClass>*/
}
{
...
{
var40 = ((val*(*)(val* self, val* p0, val* p1))(var_prefix->class->vft[COLOR_nit__vm__MClass__dfs]))(var_prefix, var_v, var_prefix_res); /* dfs on <var_prefix:nullable Object(MClass)>*/
}
...
var_res = var48;
{
var49 = ((val*(*)(val* self, val* p0, val* p1))(var_cl46->class->vft[COLOR_nit__vm__MClass__dfs]))(var_cl46, var_v, var_res); /* dfs on <var_cl46:MClass>*/
}
var_res = var49;
var_50 = var_res;
{
...
{
var68 = ((val*(*)(val* self, val* p0, val* p1))(var67->class->vft[COLOR_nit__vm__MClass__dfs]))(var67, var_v, var_res); /* dfs on <var67:nullable Object(MClass)>*/
}
var_res = var68;
} else {
}
...
/* method vm#MClass#update_positions for (self: MClass, Int, Int, MClass) */
void nit__vm___MClass___update_positions(val* self, long p0, long p1, val* p2) {
...
var_cl = p2;
{
var = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__positions_attributes]))(self); /* positions_attributes on <self:MClass>*/
}
{
...
{
var2 = ((val*(*)(val* self))(self->class->vft[COLOR_nit__vm__MClass__positions_methods]))(self); /* positions_methods on <self:MClass>*/
}
{
...
/* method vm#MAttribute#offset for (self: MAttribute): Int */
long nit__vm___MAttribute___offset(val* self) {
long var /* : Int */;
long var1 /* : Int */;
var1 = self->attrs[COLOR_nit__vm__MAttribute___offset].l; /* _offset on <self:MAttribute> */
var = var1;
RET_LABEL:;
return var;
}
/* method vm#MAttribute#offset= for (self: MAttribute, Int) */
void nit__vm___MAttribute___offset_61d(val* self, long p0) {
self->attrs[COLOR_nit__vm__MAttribute___offset].l = p0; /* _offset on <self:MAttribute> */
RET_LABEL:;
}
/* method vm#MAttribute#absolute_offset for (self: MAttribute): Int */
long nit__vm___MAttribute___absolute_offset(val* self) {
long var /* : Int */;
long var1 /* : Int */;
var1 = self->attrs[COLOR_nit__vm__MAttribute___absolute_offset].l; /* _absolute_offset on <self:MAttribute> */
var = var1;
RET_LABEL:;
return var;
}
/* method vm#MAttribute#absolute_offset= for (self: MAttribute, Int) */
void nit__vm___MAttribute___absolute_offset_61d(val* self, long p0) {
self->attrs[COLOR_nit__vm__MAttribute___absolute_offset].l = p0; /* _absolute_offset on <self:MAttribute> */
RET_LABEL:;
}
/* method vm#MMethod#offset for (self: MMethod): Int */
long nit__vm___MMethod___offset(val* self) {
long var /* : Int */;
long var1 /* : Int */;
var1 = self->attrs[COLOR_nit__vm__MMethod___offset].l; /* _offset on <self:MMethod> */
var = var1;
RET_LABEL:;
return var;
}
/* method vm#MMethod#offset= for (self: MMethod, Int) */
void nit__vm___MMethod___offset_61d(val* self, long p0) {
self->attrs[COLOR_nit__vm__MMethod___offset].l = p0; /* _offset on <self:MMethod> */
RET_LABEL:;
}
/* method vm#MMethod#absolute_offset for (self: MMethod): Int */
long nit__vm___MMethod___absolute_offset(val* self) {
long var /* : Int */;
long var1 /* : Int */;
var1 = self->attrs[COLOR_nit__vm__MMethod___absolute_offset].l; /* _absolute_offset on <self:MMethod> */
var = var1;
RET_LABEL:;
return var;
}
/* method vm#MMethod#absolute_offset= for (self: MMethod, Int) */
void nit__vm___MMethod___absolute_offset_61d(val* self, long p0) {
self->attrs[COLOR_nit__vm__MMethod___absolute_offset].l = p0; /* _absolute_offset on <self:MMethod> */
RET_LABEL:;
}
/* method vm#MutableInstance#internal_attributes for (self: MutableInstance): Pointer */
val* nit__vm___MutableInstance___internal_attributes(val* self) {
val* var /* : Pointer */;
val* var1 /* : Pointer */;
var1 = self->attrs[COLOR_nit__vm__MutableInstance___internal_attributes].val; /* _internal_attributes on <self:MutableInstance> */
if (unlikely(var1 == NULL)) {
...
/* method vm#MutableInstance#internal_attributes= for (self: MutableInstance, Pointer) */
void nit__vm___MutableInstance___internal_attributes_61d(val* self, val* p0) {
self->attrs[COLOR_nit__vm__MutableInstance___internal_attributes].val = p0; /* _internal_attributes on <self:MutableInstance> */
RET_LABEL:;
}
/* method vm#Instance#vtable for (self: Instance): nullable VTable */
val* nit__vm___Instance___vtable(val* self) {
val* var /* : nullable VTable */;
val* var1 /* : nullable VTable */;
var1 = self->attrs[COLOR_nit__vm__Instance___vtable].val; /* _vtable on <self:Instance> */
var = var1;
RET_LABEL:;
return var;
}
/* method vm#Instance#vtable= for (self: Instance, nullable VTable) */
void nit__vm___Instance___vtable_61d(val* self, val* p0) {
self->attrs[COLOR_nit__vm__Instance___vtable].val = p0; /* _vtable on <self:Instance> */
RET_LABEL:;
}
/* method vm#MInitType#model for (self: MInitType): Model */
val* nit___nit__MInitType___nit__model_base__MEntity__model(val* self) {
val* var /* : Model */;
val* var1 /* : Model */;
var1 = self->attrs[COLOR_nit__vm__MInitType___model].val; /* _model on <self:MInitType> */
if (unlikely(var1 == NULL)) {
...
self->attrs[COLOR_nit__vm__MInitType___model].val = p0; /* _model on <self:MInitType> */
RET_LABEL:;
}
/* method vm#MInitType#to_s for (self: MInitType): String */
...
/* method vm#MInitType#as_nullable for (self: MInitType): MType */
...
/* method vm#MInitType#need_anchor for (self: MInitType): Bool */
...
/* method vm#MInitType#resolve_for for (self: MInitType, MType, nullable MClassType, MModule, Bool): MType */
...
/* method vm#MInitType#can_resolve_for for (self: MInitType, MType, nullable MClassType, MModule): Bool */
...
/* method vm#MInitType#collect_mclassdefs for (self: MInitType, MModule): Set[MClassDef] */
...
/* method vm#MInitType#collect_mclasses for (self: MInitType, MModule): Set[MClass] */
...
/* method vm#MInitType#collect_mtypes for (self: MInitType, MModule): Set[MClassType] */
...
/* method vm#MInitType#init for (self: MInitType) */
...
/* method vm#VTable#mask for (self: VTable): Int */
long nit___nit__VTable___mask(val* self) {
long var /* : Int */;
long var1 /* : Int */;
var1 = self->attrs[COLOR_nit__vm__VTable___mask].l; /* _mask on <self:VTable> */
var = var1;
RET_LABEL:;
return var;
}
...
self->attrs[COLOR_nit__vm__VTable___mask].l = p0; /* _mask on <self:VTable> */
RET_LABEL:;
}
/* method vm#VTable#id for (self: VTable): Int */
long nit___nit__VTable___id(val* self) {
long var /* : Int */;
long var1 /* : Int */;
var1 = self->attrs[COLOR_nit__vm__VTable___id].l; /* _id on <self:VTable> */
var = var1;
RET_LABEL:;
return var;
}
...
self->attrs[COLOR_nit__vm__VTable___id].l = p0; /* _id on <self:VTable> */
RET_LABEL:;
}
/* method vm#VTable#internal_vtable for (self: VTable): Pointer */
val* nit___nit__VTable___internal_vtable(val* self) {
val* var /* : Pointer */;
val* var1 /* : Pointer */;
var1 = self->attrs[COLOR_nit__vm__VTable___internal_vtable].val; /* _internal_vtable on <self:VTable> */
if (unlikely(var1 == NULL)) {
...
self->attrs[COLOR_nit__vm__VTable___internal_vtable].val = p0; /* _internal_vtable on <self:VTable> */
RET_LABEL:;
}
/* method vm#VTable#classname for (self: VTable): String */
val* nit___nit__VTable___classname(val* self) {
val* var /* : String */;
val* var1 /* : String */;
var1 = self->attrs[COLOR_nit__vm__VTable___classname].val; /* _classname on <self:VTable> */
if (unlikely(var1 == NULL)) {
...
self->attrs[COLOR_nit__vm__VTable___classname].val = p0; /* _classname on <self:VTable> */
RET_LABEL:;
}
/* method vm#MemoryManager#init_vtable for (self: MemoryManager, Array[Int], Array[Int], Array[Int], Int): Pointer */
...
var_mask = p3;
{
var1 = ((val*(*)(val* self, val* p0, val* p1, val* p2, long p3))(self->class->vft[COLOR_nit__vm__MemoryManager__intern_init_vtable]))(self, var_ids, var_nb_methods, var_nb_attributes, var_mask); /* intern_init_vtable on <self:MemoryManager>*/
}
var_res = var1;
var = var_res;
goto RET_LABEL;
...
/* method vm#MemoryManager#intern_init_vtable for (self: MemoryManager, Array[Int], Array[Int], Array[Int], Int): Pointer */
...
var_for_c_3 = nit_alloc(sizeof(struct nitni_instance));
var_for_c_3->value = p2;
var1 = vm___MemoryManager_intern_init_vtable___impl(var_for_c_0, var_for_c_1, var_for_c_2, var_for_c_3, p3);
var2 = BOX_standard__Pointer(var1); /* boxing Pointer */
var2->type = &type_standard__Pointer;
var2->class = &class_standard__Pointer;
var = var2;
...
/* nitni callback for standard::Collection::length */
long vm___Array_of_Int_length( struct nitni_instance * recv ) {
long var /* : Int */;
{
...
/* nitni callback for standard::SequenceRead::[] */
long vm___Array_of_Int__index( struct nitni_instance * recv, long index ) {
val* var /* : nullable Object */;
long var1 /* : Int */;
{
...
/* method vm#MemoryManager#put_methods for (self: MemoryManager, Pointer, Int, Int, Array[MMethodDef]) */
...
vm___MemoryManager_put_methods___impl(var_for_c_0, var, p1, p2, var_for_c_4);
RET_LABEL:;
}
/* nitni callback for standard::Collection::length */
long vm___Array_of_MMethodDef_length( struct nitni_instance * recv ) {
long var /* : Int */;
{
...
/* nitni callback for standard::SequenceRead::[] */
struct nitni_instance * vm___Array_of_MMethodDef__index( struct nitni_instance * recv, long index ) {
val* var /* : nullable Object */;
{
