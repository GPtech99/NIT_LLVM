...
private class LLVMPhase
	...
	do
		...
		for mclass in full_mclass_hierarchy 
			do
				...
				if my_mproperties.is_empty == false then
					...
					for my_mproperty in my_mproperties
						do				
		...
		fw.close
		ll.close
	end#fun process_mainmodule

end#class LLVMPhase

print "--------------Start toolcontext--------------"

var toolcontext = new ToolContext
toolcontext.process_options(args)
print "--------------Start toolcontext Complete--------------"
...
print "--------------mbuilder run_phases--------------"
mbuilder.run_phases
print "--------------mbuilder run_phases Complete--------------"

print "--------------toolcontext run_global_phases--------------"
toolcontext.run_global_phases(mmodules)
print "--------------toolcontext run_global_phases Complete--------------"
